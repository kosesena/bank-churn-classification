...
## 📊 Veri Seti Ne İçeriyor?

**10.000 müşterinin** aşağıdaki bilgileri veri setinde yer alıyor:

| Öznitelik | Açıklama | Örnek |
|-----------|----------|-------|
| `CreditScore` | Kredi puanı | 619 |
| `Geography` | Ülke | France, Spain, Germany |
| `Gender` | Cinsiyet | Male, Female |
| `Age` | Yaş | 42 |
| `Tenure` | Bankadaki yıl sayısı | 2 |
| `Balance` | Hesap bakiyesi | 33.034 € |
| `NumOfProducts` | Kullanılan ürün sayısı | 1 |
| `HasCrCard` | Kredi kartı var mı? | Evet (1) / Hayır (0) |
| `IsActiveMember` | Aktif üye mi? | Evet (1) / Hayır (0) |
| `EstimatedSalary` | Tahmini maaş | 99.027 € |
| **`Exited`** | **Ayrıldı mı? (Hedef)** | **1 = Ayrıldı, 0 = Kaldı** |
